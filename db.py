from pymongo import DESCENDING, message, MongoClient
...
def get_messages(room_id, page=0):
    ...
    messages = list(messages_collection.find({'room_id': room_id}).sort('_id', DESCENDING).limit(MESSAGE_FETCH_LIMIT
    ).skip(offset))
